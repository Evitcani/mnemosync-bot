...
const message_responder_1 = require("./bot/services/message-responder");
const DatabaseService_1 = require("./backend/database/base/DatabaseService");
const PartyFundCommandHandler_1 = require("./bot/command-handlers/world/party/inventory/PartyFundCommandHandler");
const RegisterCommandHandler_1 = require("./bot/command-handlers/misc/RegisterCommandHandler");
const PartyToGuildService_1 = require("./backend/database/PartyToGuildService");
...
const WhichCommandHandler_1 = require("./bot/command-handlers/world/information/WhichCommandHandler");
const SpecialChannelService_1 = require("./backend/database/SpecialChannelService");
const HelpCommandHandler_1 = require("./bot/command-handlers/misc/HelpCommandHandler");
const QuoteCommandHandler_1 = require("./bot/command-handlers/misc/QuoteCommandHandler");
const BagCommandHandler_1 = require("./bot/command-handlers/world/party/inventory/BagCommandHandler");
const CharacterCommandHandler_1 = require("./bot/command-handlers/world/party/character/CharacterCommandHandler");
const TravelCommandHandler_1 = require("./bot/command-handlers/world/information/TravelCommandHandler");
...
const WorldCommandHandler_1 = require("./bot/command-handlers/world/information/WorldCommandHandler");
...
const SendingCommandHandler_1 = require("./bot/command-handlers/world/party/character/SendingCommandHandler");
...
const DateCommandHandler_1 = require("./bot/command-handlers/world/information/DateCommandHandler");
const CalendarCommandHandler_1 = require("./bot/command-handlers/world/information/CalendarCommandHandler");
const PartyCommandHandler_1 = require("./bot/command-handlers/world/party/PartyCommandHandler");
...
container.bind(types_1.TYPES.PartyCommandHandler).to(PartyCommandHandler_1.PartyCommandHandler).inSingletonScope();
...
container.bind(types_1.TYPES.CalendarMoonPhaseController).to(CalendarMoonPhaseController_1.CalendarMoonPhaseController).inSingletonScope();
